...
To configure the Matter Device Type Identifier value to the one matching the used device type you need to set `CONFIG_CHIP_DEVICE_TYPE` option. For example the Dimmable Light device type value is equal to `257 (0x0101)`.
