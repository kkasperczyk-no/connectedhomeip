...
public:
    ...
    CHIP_ERROR GetUpdateProgress(EndpointId endpointId, uint8_t & progress);

    // Get requestor state
    CHIP_ERROR GetState(EndpointId endpointId, app::Clusters::OtaSoftwareUpdateRequestor::OTAUpdateStateEnum & state);
